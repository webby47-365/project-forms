...
$archive = [System.IO.Compression.ZipFile]::Open($zip, 'Read', [System.Text.Encoding]::UTF8)
$count = 0
try {
...
Write-Ok "파일 $count 개 갱신"
if (-not $KeepBundle) { Remove-Item $zip -Force; Write-Ok "갱신용 압축파일 삭제" }
